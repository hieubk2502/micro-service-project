package com.dev.notification.repository.httpclient;
...
public interface EmailClient {
    ...
    EmailResponse sendEmail(@RequestHeader("api-key") String apiKey,@RequestBody SendEmailRequest emailRequest);
}
